SourceTrait AI Empower: NuBed
================================================================================
[![Crate Badge]][Crate] [![Docs Badge]][Docs] [![License Badge]][License] [![AI Badge]][AI]

*Isolated nushell embedding engine for purely functional filter scripts*
...
License (AGPL3)
--------------------------------------------------------------------------------
SourceTrait AI Empower NuBed: Isolated nushell embedding engine  
...
[Crate]: https://crates.io/crates/sourcetrait_ai_empower_nubed
[Crate Badge]: https://img.shields.io/crates/v/sourcetrait_ai_empower_nubed.svg
[Docs]: https://docs.rs/sourcetrait_ai_empower_nubed
