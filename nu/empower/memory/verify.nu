...
export def call [args: record<live: string, repo: string>] {
    let a = (analyze $args.live $args.repo)
...
export def resolve [args: record<match: bool, only_live: list<string>, only_repo: list<string>, content_diff: table<file: string, live_mtime: datetime, repo_mtime: datetime, repo_committed: bool>>] {
    $args
}
