...
/// the empower:pid nu helpers can bind a session_nom to a live process (the yaml
...
///
/// Why: the recorded `pid` lets the empower:pid helpers match this session to a
...
/// carries, so this agrees with the empower:pid nu helper's filter. Any
