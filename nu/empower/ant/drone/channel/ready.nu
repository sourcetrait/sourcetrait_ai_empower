...
#
# Queen-invoked once a persistent drone reports READY after its bootstrap.
# Appends "COLONY DRONE <drone_name> READY" to the fae's shared control file, so
# the fae knows the drone is reachable and may start sending it requests. Errors
# if the colony or the bonded fae has no live session, or the fae control file is
# absent. Void return.
