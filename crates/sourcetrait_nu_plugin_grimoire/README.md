SourceTrait Grimoire: Nu Plugin
================================================================================
[![License Badge]][License]

*Nushell plugin supporting SourceTrait Grimoire*
...
```nu
^cargo install --path .
cp ~/.cargo/bin/nu_plugin_grimoire ~/.config/nushell/plugins/
plugin add ~/.config/nushell/plugins/nu_plugin_grimoire
```
...
License (AGPL3)
--------------------------------------------------------------------------------
SourceTrait Grimoire Nu Plugin: Nushell plugin supported SourceTrait Grimoire  
