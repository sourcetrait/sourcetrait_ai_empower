# Drone-invoked comms channel ops for the bonded fae (sourcetrait/drone:comm).
#
...
# the channel itself via sourcetrait/queen:drone/comm. The drone has no inbox
# and does not monitor (the queen relays inbound to it).
